...
class NavSquare1():
	...
	theta=math.atan(a/b)*180/pi
	print(theta)
        # Set the parameters for the target square
        goal_distance = rospy.get_param("~goal_distance", 0.0)      # meters
        goal_angle = rospy.get_param("~goal_angle", radians(theta))    # degrees converted to radians
...
class NavSquare2():
    def __init__(self):
        ...
        # Set the parameters for the target square
        goal_distance = rospy.get_param("~goal_distance", sqrt(pow(a, 2) + pow(b, 2)))      # meters
        goal_angle = rospy.get_param("~goal_angle", radians(0))    # degrees converted to radians
        linear_speed = rospy.get_param("~linear_speed", 0.2)        # meters per second
        angular_speed = rospy.get_param("~angular_speed", 0.7)      # radians per second
        angular_tolerance = rospy.get_param("~angular_tolerance", radians(2)) # degrees to radians
